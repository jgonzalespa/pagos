...
class PagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago" do
    assert_difference("Pago.count") do
      post pagos_url, params: { pago: { anio: @pago.anio, fechapago: @pago.fechapago, mes: @pago.mes, monto: @pago.monto } }
    end
  ...
  test "should update pago" do
    patch pago_url(@pago), params: { pago: { anio: @pago.anio, fechapago: @pago.fechapago, mes: @pago.mes, monto: @pago.monto } }
